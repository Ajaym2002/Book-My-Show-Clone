      ...
      <div>
        ...
        <div className="flex flex-col gap-3 lg:hidden">
          ...
          <div className="flex items-center gap-3 mid:px-4 md:w-screen text-xl px-4">
            <button className="bg-red-500 w-full py-3 rounded-lg text-white font-semibold">Rent ₹ 149</button>
            <button className="bg-red-500 w-full py-3 rounded-lg text-white font-semibold">Buy ₹ 599</button>
          </div>
        </div>
